 ...
 * conocida se queda el código, que se lee igual de bien; sin color propio, porque
 * va igual sobre papel que sobre el marco oscuro.
 */
...
<template>
  <img
    ...
    :class="SIZES[size]"
  />
  <span v-else-if="code" class="text-xs font-semibold opacity-75">{{ code }}</span>
</template>
